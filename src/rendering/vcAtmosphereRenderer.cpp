...
bool vcAtmosphereRenderer_InitModel(vcAtmosphereRenderer *pAtmosphereRenderer);
...
bool vcAtmosphereRenderer_Render(vcAtmosphereRenderer *pAtmosphereRenderer, vcState *pProgramState)
{
  bool result = true;

  HandleFakeInput(pAtmosphereRenderer);
...
bool vcAtmosphereRenderer_InitModel(vcAtmosphereRenderer *pAtmosphereRenderer)
{
  ...
  pModel->SetProgramUniforms(pAtmosphereRenderer->renderShader.pProgram->programID, 0, 1, 2, 3);
...
void HandleFakeInput(vcAtmosphereRenderer *pAtmosphereRenderer)
{
