...
udResult vcWaterRenderer_Init()
{
  ...
  UD_ERROR_IF(vcTexture_CreateFromFilename(&pNormalMapTexture, "asset://assets/textures/waterNormalMap.jpg", nullptr, nullptr, vcTextureFormat_RGBA8, vcTFM_Linear, true, vcTWM_Repeat), udR_InternalError);
